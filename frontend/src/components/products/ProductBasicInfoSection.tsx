...
export interface BasicInfoSectionHandle {
  setCategory: (value: string) => void;
  setModelCode: (value: string) => void;
  setSpecKeywords: (updater: (prev: string) => string) => void;
}
...
export const ProductBasicInfoSection = forwardRef<BasicInfoSectionHandle, ProductBasicInfoSectionProps>(function ProductBasicInfoSection({
  product,
  userId,
  productId,
  highlightedAnchor,
  ...
  // Expose setters to parent via ref
  useImperativeHandle(ref, () => ({
    setCategory: (value: string) => setEditableCategory(value),
    setModelCode: (value: string) => setEditableModelCode(value),
    setSpecKeywords: (updater: (prev: string) => string) => setEditableSpecKeywords(updater),
  }), []);
  ...
  const priceFilterRangePreview = {
    minPct: Number.isFinite(normalizedEditedMinPct as number) ? normalizedEditedMinPct : null,
    maxPct: Number.isFinite(normalizedEditedMaxPct as number) ? normalizedEditedMaxPct : null,
  };
  ...
  const handleSaveTrackingFields = () => {
    ...
    if (normalizedMinPctVal != null && normalizedMaxPctVal != null && normalizedMinPctVal > normalizedMaxPctVal) {
